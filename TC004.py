...
# Buy Appia
beers = chrome_browser.find_element_by_css_selector("#category-Cervejas").click()
colorado = chrome_browser.find_element_by_css_selector("#image-brand-Colorado").click()
appia = chrome_browser.find_element_by_css_selector("a[title='Colorado Appia 350ml'] div[class='css-1tkwx94']").click()
def appiaAddBtn() : chrome_browser.find_element_by_css_selector('#add-amount-10').click()
i = 1
while i < 10:
    appiaAddBtn()
    i += 1
