...
| [`TC005`](https://github.com/RobertoSaback/ZeChallenge/blob/master/TC005.py) | Verify if the user can select items from different categories |<ul> <li>Have a valid account on Zé Delivery</li><li> Stay logged in</li></ul> | <ul> <li>On the product page select beer category</li><li>On the beer category select Brahma Brand</li><li>using add +10 items button add 90 brahmas Puro Malte in the bag</li><li>Proceed to the spirits category</li><li>Go to beats brand</li><li>Using add +10 button add 90 Beats Senses 269ml to the bag</li><li>Proceed to the wine category</li><li>Select white wines</li><li>With add +10 button proceed with 90 foye wine to the bag</li></ul> | A message shows up say that those items are not mixable | The user could add all kinds of items to the bag | Failed|
